...
-(void)buildViews{
    ...
    //message
    CGFloat messageHeigh = [self heightWithString:_message fontSize:15 width:AlertWidth-2*AlertPadding];
    ...
    _labelmessage.font = [UIFont fontWithName:@"Helvetica-Bold" size:15];;
