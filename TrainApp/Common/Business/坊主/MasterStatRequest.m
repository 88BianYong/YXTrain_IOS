...
@implementation MasterStatRequestItem_Body_Type_Detail
...
@end
@implementation MasterStatRequestItem_Body_Type
@end
@implementation MasterStatRequestItem_Body
@end
@implementation MasterStatRequestItem
@end
@implementation MasterStatRequest
- (instancetype)init
{
    if (self = [super init]) {
        self.urlHead = [[LSTSharedInstance sharedInstance].configManager.server stringByAppendingString:@"peixun/master/masterStat"];
    }
    return self;
}
@end
