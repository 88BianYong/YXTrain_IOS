...
{
    return [[JSONKeyMapper alloc] initWithModelToJSONDictionary:@{@"id":@"elementId"}];
}
@end
...
{
    if (self = [super init]) {
        self.urlHead = [[LSTSharedInstance sharedInstance].configManager.server stringByAppendingString:@"search/stagecataelelist"];
    }
    return self;
}
