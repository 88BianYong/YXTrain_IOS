...
@interface ActivityFilterFooterView_17 ()
@property (nonatomic, strong) UIView *lineView;
@property (nonatomic, strong) UIButton *cancleButton;
@property (nonatomic, strong) UIButton *confirmButton;
@end
@implementation ActivityFilterFooterView_17
...
- (void)setupUI {
    ...
    [[self.cancleButton rac_signalForControlEvents:UIControlEventTouchUpInside] subscribeNext:^(id x) {
        STRONG_SELF
        BLOCK_EXEC(self.activitFilterCompleteBlock,YES);
    }];
    ...
    [[self.confirmButton rac_signalForControlEvents:UIControlEventTouchUpInside] subscribeNext:^(id x) {
        STRONG_SELF
        BLOCK_EXEC(self.activitFilterCompleteBlock,NO);
    }];
