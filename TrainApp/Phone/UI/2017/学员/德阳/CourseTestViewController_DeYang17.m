//
//  CourseTestViewController_DeYang17.m
//  TrainApp
//
...
@interface CourseTestViewController_DeYang17 ()<UITableViewDelegate,UITableViewDataSource>
@property (nonatomic, strong) YXNoFloatingHeaderFooterTableView *tableView;
@property (nonatomic, strong) CourseTestTableHeaderView_DeYang17 *headerView;
...
@implementation CourseTestViewController_DeYang17
...
- (void)setQuizesItem:(CourseGetQuizesRequest_17Item *)quizesItem{
    ...
    if (_quizesItem.result.status.integerValue != 0) {
        self.headerView.frame = CGRectMake(0, 0, kScreenWidth, 75.0f);
    }
...
- (void)setupUI {
    ...
    self.headerView = [[CourseTestTableHeaderView_DeYang17 alloc] initWithFrame:CGRectMake(0, 0, kScreenWidth, 101.0f)];
