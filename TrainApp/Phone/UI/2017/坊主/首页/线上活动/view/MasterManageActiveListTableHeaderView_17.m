...
- (void)setScheme:(MasterManagerSchemeItem *)scheme {
    _scheme = scheme;
    [self.schemeView reloadMasterScheme:[NSString stringWithFormat:@"需要发布%@个活动(手机端暂不支持发布活动)",_scheme.amount] withFinishNum:_scheme.userfinishnum withAmount:_scheme.amount];
