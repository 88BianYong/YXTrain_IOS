...
@interface MasterHomeworkAffixsCell_17 ()
@property (nonatomic, strong) UILabel *titleLabel;
@property (nonatomic, strong) UIImageView *typeImageView;
@property (nonatomic, strong) UIView *cellSeperatorView;
@end
@implementation MasterHomeworkAffixsCell_17
...
- (void)setAffix:( MasterHomeworkDetailItem_Body_Template_Affixs *)affix {
    _affix = affix;
