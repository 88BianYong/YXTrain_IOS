//
//  MasterHomeworkSetListCell_17.m
//  TrainApp
//
...
@interface MasterHomeworkSetListCell_17 ()
...
@end
@implementation MasterHomeworkSetListCell_17
...
#pragma mark - set
- (void)setHomework:(MasterHomeworkSetListItem_Body_Homework *)homework {
...
- (void)setupLayout {
    [self.titleLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.right.equalTo(self.contentView.mas_right).offset(-80.0f);
    }];
