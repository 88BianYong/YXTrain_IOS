//
//  MasterHomeworkSetAffixCell_17.m
//  TrainApp
//
...
@interface MasterHomeworkSetAffixCell_17 ()
@property (nonatomic, strong) UILabel *titleLabel;
@property (nonatomic, strong) UIImageView *typeImageView;
@property (nonatomic, strong) UIView *cellSeperatorView;
@end
@implementation MasterHomeworkSetAffixCell_17
...
- (void)setAffix:(MasterHomeworkSetDetailItem_Template_Affix *)affix {
    _affix = affix;
