...
- (void)setupUI{
    ...
    [button setTitleColor:[UIColor colorWithHexString:@"cf2627"] forState:UIControlStateNormal];
    [button setTitleColor:[UIColor whiteColor] forState:UIControlStateHighlighted];
    [button setBackgroundImage:[UIImage yx_imageWithColor:[UIColor colorWithHexString:@"cf2627"]] forState:UIControlStateHighlighted];
    [button setTitle:@"意见反馈" forState:UIControlStateNormal];
    button.titleLabel.font = [UIFont systemFontOfSize:15.0f];
    button.layer.cornerRadius = YXTrainCornerRadii;
    button.layer.borderWidth = 1.0f;
    button.layer.borderColor = [UIColor colorWithHexString:@"cf2627"].CGColor;
...
- (NSArray *)formatData{
    ...
    item1.contentString = @"如您只参加了一个在培项目，进入i研修后会默认当前的一个项目。如参加了多个在培项目请点击最上方向下的箭头后，选择对应的项目名称进入.";
    item1.isOpen = NO;
    
    YXHelpItem *item2 = [[YXHelpItem alloc] init];
    item2.titleString = @"哪里可以看到课程呢?";
    item2.contentString = @"进入i研修后，默认到考核页面，点击课程后进入课程列表，就可以观看课程了。在课程列表处还可以根据学段、学科、阶段选择课程进行学习.";
    item2.isOpen = NO;
    ...
    item4.contentString = @"i研修目前只开放了课程观看的功能，作业和活动暂时未开放，请您到电脑端完成.";
    item4.isOpen = NO;
    
    YXHelpItem *item5 = [[YXHelpItem alloc] init];
    item5.titleString = @"我的学习成绩从哪里查到?";
    item5.contentString = @"进入i研修后，在默认的总成绩处点击进入就看查询到您的总的学习成绩和阶段的学习成绩啦.";
    item5.isOpen = NO;
    
    YXHelpItem *item6 = [[YXHelpItem alloc] init];
    item6.titleString = @"我想在i研修上传资源可以吗?";
    item6.contentString = @"目前i研修只开放了资源查看的功能，上传暂时未开放，请您到电脑端完成.";
    item6.isOpen = NO;
    
    YXHelpItem *item7 = [[YXHelpItem alloc] init];
    item7.titleString = @"我想在i研修的工作坊发问答可以吗?";
    item7.contentString = @"目前i研修的工作坊只开放了工作坊人员查看和资源查看功能，其他功能暂时未开放，请您到电脑端完成.";
    item7.isOpen = NO;
