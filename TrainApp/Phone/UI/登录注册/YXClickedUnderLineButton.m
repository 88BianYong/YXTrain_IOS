...
- (void)setUpUI {
    ...
    [self.button setTitleColor:[UIColor colorWithHexString:@"41c694"] forState:UIControlStateNormal];
    ...
    self.bottomView.backgroundColor = [UIColor colorWithHexString:@"41c694"];
