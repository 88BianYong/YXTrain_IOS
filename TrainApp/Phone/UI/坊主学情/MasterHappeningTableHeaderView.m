//
//  MasterHappeningTableHeaderView.m
//  TrainApp
//
//  Created by 郑小龙 on 17/2/14.
//  Copyright © 2017年 niuzhaowang. All rights reserved.
//
@interface MasterTableHeaderLabel : UIView
@end
@implementation MasterTableHeaderLabel
...
- (void)setupUI {
    ...
    self.bottomExplainLabel = [[MasterTableHeaderLabel alloc] initWithExplain:@"成绩数据更新约有延迟5小时,如有异常请稍后查看"];
