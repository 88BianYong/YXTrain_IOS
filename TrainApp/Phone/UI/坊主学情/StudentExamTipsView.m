...
- (void)setupUI {
    ...
    NSAttributedString *attString = [[NSAttributedString alloc] initWithString:@"作为本次培训中的管理者,您不需要进行学员内容的学习,此部分展示仅为方便您老姐学员学习内容,进仅需要进行该项目指导即可" attributes:@{NSParagraphStyleAttributeName : paragraphStyle}];
